...
subroutine chemistry_step(conc,time1,time2,O2_in,N2_in,M_in,H2O_in,TEMP_in,exp_coszen, F_monoterpene , F_isoprene)
  real(dp), intent(inout) :: conc(neq)
  real(dp), intent(in)    :: time1, time2, O2_in, N2_in, M_in, H2O_in, TEMP_in
  real(dp), intent(in)    :: exp_coszen
  real(dp) :: F_monoterpene , F_isoprene
...
subroutine calculate_k(exp_coszen, F_monoterpene , F_isoprene)
   ...
   k_rate(31) = F_monoterpene !Emi_alp                                                                                    ! Emission rate of alpha-pinene
   k_rate(32) = F_isoprene !Emi_iso                                                                                    ! Emission rate of isoprene
...
subroutine f_lsode(neq, time, conc, conc_dot)
  ...
  ! 3 = OH
  conc_dot(3)  = 2*k_rate(2)*conc(2)*H2O - k_rate(7)*conc(3)*conc(9) - k_rate(8)*conc(3)*conc(11) - k_rate(9)*conc(3)*conc(13) - &
  ...
  ! 7 = CH2O
  conc_dot(7)  = -k_rate(6)*conc(7) + k_rate(10)*conc(3)*conc(15) + k_rate(12)*conc(12)*conc(6) + &
                 k_rate(13)*conc(14)*conc(6) - k_rate(14)*conc(3)*conc(7)

  ! 8 = HO2
  conc_dot(8)  = k_rate(6)*conc(7) + k_rate(7)*conc(3)*conc(9) + k_rate(10)*conc(3)*conc(15) - k_rate(11)*conc(8)*conc(6) + &
                k_rate(12)*conc(12)*conc(6) + k_rate(13)*conc(14)*conc(6) + k_rate(14)*conc(3)*conc(7) - &
                2*k_rate(15)*conc(8)**2 - k_rate(16)*conc(12)*conc(8) - k_rate(17)*conc(14)*conc(8) - &
  ...
  ! 15 = MVK
  conc_dot(15) = -k_rate(10)*conc(15)*conc(3) + k_rate(13)*conc(14)*conc(6)

  ! 16 = H2O2
  conc_dot(16) = k_rate(15)*conc(8)**2 - k_rate(21)*conc(3)*conc(16)

  ! 17 = HNO3
  conc_dot(17) = k_rate(18)*conc(3)*conc(5) + 2*k_rate(27)*conc(19)*H2O**2 + 2*conc(19)*H2O*k_rate(26) - k_rate(30)*conc(17)

  ! 18 = NO3
  conc_dot(18) = -k_rate(22)*conc(6)*conc(18) + k_rate(23)*conc(5)*conc(1) - k_rate(24)*conc(5)*conc(18) + k_rate(25)*conc(19)

  ! 19 = N2O5
  conc_dot(19) = k_rate(24)*conc(5)*conc(18) - k_rate(25)*conc(19) - k_rate(26)*conc(19)*H2O - k_rate(27)*conc(19)*H2O**2
...
! write(*,*) conc_dot(23), k_rate(31),  k_rate(33)*conc(23)*conc(3), k_rate(34)*conc(23)*conc(1)
  ! 23 = Alpha-pinene
